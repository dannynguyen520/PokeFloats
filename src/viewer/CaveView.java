...
public class CaveView extends BorderPane implements Observer {
	...
	public CaveView(GameObject x){
		...
		background = new Image("file:images/map/cave.png");
	...
	private class AnimationStarter implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent arg0) {
			...
			if(!game.getCurrMap().getDoors().containsKey(player))
				gc.drawImage(background, camera.x - 153, camera.y - 86, 447, 298, 0, 0, 894, 596);
